...
i = 0
import re
os.chdir('/Users/abishek/Desktop/IIT_M/verification')
for name in df_sample['Test Dir']:
    grep_check = None
    reason = None
    diff_disass = None
    cur_dir = os.getcwd()
    os.chdir(os.path.join('jul_19_workdir',name))
    os.system('source /Users/abishek/Desktop/IIT_M/verification/comp_script.sh spike.dump rtl.dump > temp.txt')
    out = ""
